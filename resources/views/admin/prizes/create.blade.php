...
<div class="card">
    ...
    <form method="POST" action="{{ route('lfl.admin.prizes.store') }}" style="display: grid; gap: 20px; max-width: 800px;">
        @csrf
        ...
        <div>
            ...
            <select id="type" name="type" required style="width: 100%; padding: 8px; border: 1px solid #ddd; border-radius: 4px;">
                ...
                <option value="feature_unlock" {{ old('type') === 'feature_unlock' ? 'selected' : '' }}>Feature Unlock</option>
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px;">
            <div>
                ...
                <input type="number" id="cost_in_points" name="cost_in_points" value="{{ old('cost_in_points', 0) }}" min="0" step="0.01" style="width: 100%; padding: 8px; border: 1px solid #ddd; border-radius: 4px;">
            ...
            <div>
                ...
                <input type="number" id="inventory_quantity" name="inventory_quantity" value="{{ old('inventory_quantity') }}" min="0" style="width: 100%; padding: 8px; border: 1px solid #ddd; border-radius: 4px;" placeholder="Leave empty for unlimited">
        ...
        <div style="display: flex; gap: 10px; margin-top: 20px;">
            <button type="submit" style="background: #007bff; color: white; padding: 10px 20px; border: none; border-radius: 4px; cursor: pointer; font-weight: bold;">Create Prize</button>
